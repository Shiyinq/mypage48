...
class AchievementConfig:
    ...
    ATTENDANCE = [
        AchievementDef(
            "first_show",
            "First Step",
            "Attended your first theater show",
            "heart",
            "red",
            1,
        ),
    ...
    SAME_SHOW = [
        AchievementDef(
            "super_fan",
            "Super Fan",
            "Watched the same event 10 times",
            "star",
            "yellow",
            10,
        ),
        AchievementDef(
            "mega_fan",
            "Mega Fan",
            "Watched the same event 20 times",
            "sparkles",
            "orange",
            20,
        ),
        AchievementDef(
            "ultra_fan",
            "Ultra Fan",
            "Watched the same event 30 times",
            "flame",
            "red",
            30,
        ),
    ...
    ANNIVERSARY = [
        AchievementDef(
            "theater_enthusiast",
            "Theater Enthusiast",
            "1 year anniversary since first show",
            "calendar",
            "blue",
            365,
        ),
        AchievementDef(
            "theater_veteran",
            "Theater Veteran",
            "2 year anniversary since first show",
            "history",
            "indigo",
            730,
        ),
        AchievementDef(
            "theater_legend",
            "Theater Legend",
            "3 year anniversary since first show",
            "crown",
            "violet",
            1095,
        ),
    ...
    ROW = [
        AchievementDef(
            "elite_row", "Elite Seat", "Sat in the legendary Row A", "crown", "purple"
        ),
        AchievementDef(
            "back_row_warrior",
            "Back Row Warrior",
            "Watched from the furthest row (Row J)",
            "binoculars",
            "indigo",
        ),
        AchievementDef(
            "seat_explorer",
            "Seat Explorer",
            "Collected a ticket for every row (A-J)",
            "armchair",
            "pink",
            10,
        ),
    ...
    SPENDING = [
        AchievementDef(
            "supporter",
            "Top Supporter",
            "Spent over 5 Million IDR on tickets",
            "wallet",
            "emerald",
            5000000,
        ),
