...
from src.achievements.schemas import RankInfo, AchievementItem, AchievementsResponse
...
class AchievementsService:
    ...
    def calculate_achievements_full(self, tickets: list) -> List[dict]:
        ...
        for ach in AchievementConfig.ATTENDANCE:
            ...
            achievements.append({
                ...
                "progress": f"{min(current, ach.threshold)}/{ach.threshold}" if ach.threshold > 1 else None,
            })
    ...
    async def get_achievements(self, user_id: str) -> AchievementsResponse:
        ...
        try:
            ...
            achievements = [
                AchievementItem(**ach) for ach in achievements_data
            ]
