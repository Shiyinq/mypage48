...
from src.storage.constants import Info
...
class StorageService:
    ...
    def _generate_filename(
        self, user_id: str, category: str, content_type: str
    ) -> str:
    ...
    def resolve_public_user_images(self, user: "PublicUserResponse") -> "PublicUserResponse":
    ...
    def resolve_profile_full_images(self, profile: "ProfileFullResponse") -> "ProfileFullResponse":
        """Resolve profile picture to presigned URL for full profile."""
        profile_dict = profile.model_dump()
        
        if profile_dict.get("profile") and profile_dict["profile"].get("profilePicture"):
    ...
    def resolve_top_twoshot_images(self, response: "TopTwoShotResponse") -> "TopTwoShotResponse":
