...
>
	...
	>
		...
		<!-- Move layout, share, and restart controllers here -->
		<div class="flex items-center gap-2 sm:gap-3">
			<div
				class={`flex bg-gray-50/50 dark:bg-zinc-800/30 backdrop-blur-md rounded-full p-1 border shadow-inner ${isPublic ? 'border-gray-200 dark:border-zinc-800' : 'border-zinc-200 dark:border-zinc-800'}`}
			>
				<button
			...
			<button
				...
				class={`w-8 h-8 text-white font-black rounded-full transition-all shadow-lg flex items-center justify-center cursor-pointer ${isPublic ? 'bg-red-600 hover:bg-red-700 shadow-red-500/20' : 'bg-rose-500 hover:bg-rose-600 shadow-rose-500/20'}`}
			...
			<button
				onclick={restart}
				class={`w-8 h-8 bg-white dark:bg-zinc-800 font-black rounded-full transition-all shadow-md border flex items-center justify-center cursor-pointer ${isPublic ? 'text-slate-900 dark:text-white border-gray-200 dark:border-zinc-700 hover:bg-slate-50 dark:hover:bg-zinc-700' : 'text-themed border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700'}`}
							...
							{#each results as member, i (member.id)}
								...
								>
									...
									>
										...
										<div
											class="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-4 sm:right-4 z-30"
										>
											<h4
