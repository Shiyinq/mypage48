...
<div class="lg:col-span-2 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-4">
	...
	<div
		class="col-span-2 relative overflow-hidden bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-3xl sm:rounded-[2rem] p-5 sm:p-6 shadow-xl shadow-red-500/5 group hover:scale-[1.01] transition-transform duration-300"
	>
	...
	<!-- Top Show - Wide Card -->
	<div
		class="col-span-2 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-3xl sm:rounded-[2rem] p-5 sm:p-6 text-gray-900 dark:text-white shadow-lg shadow-yellow-500/5 relative overflow-hidden group hover:scale-[1.01] transition-transform duration-300"
	>
