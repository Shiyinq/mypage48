...
>
	...
	<div class="relative group mb-6">
		<div class="aspect-square w-full relative perspective-1000">
			<!-- Shadow -->
			<div
				class="absolute inset-4 bg-black/40 blur-2xl rounded-full translate-y-4 scale-95 opacity-50 dark:opacity-80"
			></div>
			...
			>
				...
				{:else}
					<div
						class="w-full h-full bg-gradient-to-tr from-zinc-800 to-zinc-900 flex items-center justify-center"
					>
				...
				<div class="absolute inset-0 flex items-center justify-center">
					...
					>
						...
						{/if}
						<div
							class="absolute inset-0 bg-gradient-to-tr from-transparent via-white/10 to-transparent"
						></div>
						<!-- Center hole -->
						<div
							class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-zinc-900 border border-white/20 shadow-lg"
						></div>
					</div>
				</div>
				...
				<!-- Vinyl Grooves -->
				<div
					class="absolute inset-0 rounded-full border border-white/5 pointer-events-none opacity-20"
				></div>
				<div
					class="absolute inset-4 rounded-full border border-white/5 pointer-events-none opacity-10"
				></div>
				<div
					class="absolute inset-8 rounded-full border border-white/5 pointer-events-none opacity-5"
				></div>
			</div>
		</div>
	</div>
	...
	<div class="flex items-center justify-between gap-4 mb-8">
		...
		<div
			class="flex items-center gap-2 px-3 py-1 bg-gray-50 dark:bg-zinc-800/50 rounded-full border border-gray-100 dark:border-zinc-800 group/vol"
		>
			<button
